...
comments: true
category: featured
tag: ["日本", "大阪", "旅遊指南", "廉價航空", "樂桃", "捷星", "攜程" , "Osaka", "Tokyo", "Okinawa", "budget airline", "travel guide", "FlyPeach", "Jetstar", "Skyscanner", "Expedia", "Ctrip"]
---
...
非常幸運的是班機的時段都還不錯 <br>
高雄 - 大阪 (關西機場) <span style="margin: 1em"></span> 16:25-17:55<br>
大阪 (關西機場) - 香港 <span style="margin: 1em"></span> 16:10-19:45<br>
...
2. 可以搭配信用卡進行結帳，像小編刷的是中國信託信用卡，除了促銷的折扣外，搭配紅利點數，來回機票一人約10000元左右就到手了<br>
   <div style="font-style: italic; color: #777; font-size: 13px;">*說明：樂桃航空（高雄->大阪）約 4000元/人；捷星航空（大阪->香港）約 6500元/人。</div>
<br>

這個是樂桃航空的粉紅色小飛機，真的好可愛～～<br>
連同空服員都是穿著小編最喜愛的小粉紅呢<br>
![peach-airplane]({{ site.urlimg }}osaka-trip/IMG_0084.JPG)
<br>
<br>
...
<ol>
  ...
  <li><span style="font-weight: bold;">事前購買行李公斤數會比超重補額更便宜</span><br>
    ...
    <img src="{{ site.urlimg }}osaka-trip/Jetstar-1.png" alt="jetstar-1"><br>
    <img src="{{ site.urlimg }}osaka-trip/Jetstar-2.png" alt="jetstar-2"><br>
    但不管怎麼樣，還是在一開始訂購機票時直接買足行李重量是最便宜的。<br>
    <img src="{{ site.urlimg }}osaka-trip/Screenshot-20170119-1542.png" alt="Screenshot-20170119-1542"><br>
  </li><br>
