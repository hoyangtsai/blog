...
| Semantic UI | 2013   | 46.9K           | 660.45K  | 629 KB  | 276 KB  |
...
{% include post_image.html src="https://storage.googleapis.com/spec-host-backup/mio-design%2Fassets%2F1QqdZ48smdRjk9itSexZz2DcWI92iXxR7%2Flayout-unitsmeasurements-pixeldensity-lowhigh.png" alt="grid-options" width="100%" height="auto" %}
> Pixel density - Material Design

| 裝置               | 分倍率           | viewport         |
| ------------------ | ---------------- | ---------------- |
| 華為 P30 Pro       | 1080 x 2340 像素 | 360 x 780 像素   |
| iPhone X/Xs/11 Pro | 1125 x 2436 像素 | 375 x 812 像素   |
| iPad 10.2(2019)    | 1620 x 2160 像素 | 810 x 1080 像素  |
| iPad Pro 11"       | 1668 x 2388 像素 | 834 x 1194 像素  |
| iPad Pro 12.9"     | 2048 x 2732 像素 | 1024 x 1366 像素 |
...
{% include post_image.html src="https://storage.googleapis.com/spec-host-backup/mio-design%2Fassets%2F1P_b7NIZ5_IBvs9VraJx7tu8KO-dUZXJW%2Flayout-responsive-columns-margins-gutters.png" alt="grid-options" width="100%" height="auto" %}
...
{% include post_image.html src="/images/all-resolutions-coverage-methodology/grid-options.png" alt="grid-options" width="100%" height="auto" %}

### 寬度均分

{% include post_image.html src="/images/all-resolutions-coverage-methodology/equal-width.png" alt="equal-width" width="100%" height="auto" %}
...
{% include post_image.html src="/images/all-resolutions-coverage-methodology/one-column-wider.png" alt="one-column-wider" width="100%" height="auto" %}
...
- [Boostrap Build](https://bootstrap.build/app)
    ...
    {% include post_image.html src="/images/all-resolutions-coverage-methodology/bootstrap_build.png" alt="bootstrap_build" width="100%" height="auto" %}

- [Bootstrap 4 Customizer](http://upgrade-bootstrap.bootply.com/bootstrap-4-customizer)

    {% include post_image.html src="/images/all-resolutions-coverage-methodology/bootstrap4_customizer.png" alt="bootstrap4_customizer" width="100%" height="auto" %}
...
- 容器空間 (尺寸)
    ...
    {% include post_image.html src="/images/all-resolutions-coverage-methodology/header.png" alt="header" width="100%" height="auto" %}

    {% include post_image.html src="/images/all-resolutions-coverage-methodology/header_md.png" alt="header_md" width="100%" height="auto" %}
...
- 圖片和文字
    ...
    {% include post_image.html src="/images/all-resolutions-coverage-methodology/image_and_text.png" alt="image_and_text" width="100%" height="auto" %}
