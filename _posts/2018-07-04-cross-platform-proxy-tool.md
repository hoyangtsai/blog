...
- 修改響應，替換本地假數據
- 請求轉發
- 注入 html, js, css (<a href="https://github.com/Tencent/vConsole" target="_blank">vConsole.js</a>)
- debug 遠端頁面 (操作URI <a href="https://github.com/nupthale/weinre" target="_blank">weinre</a>://)
