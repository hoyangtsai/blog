...
1. 網址層級，如 wepluscard.qq.com<span class="hi-red">/mdft/</span>index.shtml 權重比 wepluscard.qq.com<span class="hi-red">/mdft/web/</span>index.shtml 高，最好是只有 host 後面接模塊名，如 wepluscard.qq.com/index.shtml 或 wepluscard.qq.com/feature.shtml ... 等
2. 完善 meta 標籤和描述
3. 標籤語義化
...
{% include post_image.html src="/assets/image/data-management-behind-the-official-website/feature.png" alt="feature" width="100%" height="auto" %}

{% include post_image.html src="/assets/image/data-management-behind-the-official-website/feature_detail.png" alt="feature detail" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/data-management-behind-the-official-website/globalCfg_tmpl.png" alt="global template config" width="100%" height="auto" %}
...
Smarty 官方文檔：[https://www.smarty.net/documentation](https://www.smarty.net/documentation)
...
{% include post_image.html src="/assets/image/data-management-behind-the-official-website/baidu_search.png" alt="騰訊微加信用卡_百度搜索" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/data-management-behind-the-official-website/sogou_search.png" alt="騰訊微加信用卡 - 搜狗搜索" width="100%" height="auto" %}

### 合併請求

Qzone 配置系統還有另外一個問題是限制配置檔案大小，當如果一個配置內容過多時必須拆分成多個檔案，如 [幫助中心 - 騰訊微加信用卡官網](https://wepluscard.qq.com/mdft/qa.shtml)

{% include post_image.html src="/assets/image/data-management-behind-the-official-website/qzone_faq.jpg" alt="Qzone 常見問題配置" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/data-management-behind-the-official-website/globalCfg_speed_test.png" alt="全域配置測速" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/data-management-behind-the-official-website/wecard_detail_2.png" alt="逐條發佈" width="100%" height="auto" %}

勾選使用詳情發佈之後，透過選取單一數據進行發佈

{% include post_image.html src="/assets/image/data-management-behind-the-official-website/batch_publish.png" alt="Batch publish" width="100%" height="auto" %}
