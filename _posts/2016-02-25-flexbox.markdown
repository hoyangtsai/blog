...
{% include post_image.html src="/images/flexbox/flex.png" alt="flex" width="100%" height="auto" %}
...
{% include post_image.html src="/images/flexbox/flex-basis.png" alt="flex-basis" width="100%" height="auto" %}
