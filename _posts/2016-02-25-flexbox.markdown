...
{% include post_image.html src="/images/flexbox/flex.png" alt="flex" width="472" height="406" %}
...
{% include post_image.html src="/images/flexbox/flex-basis.png" alt="flex-basis" width="468" height="117" %}
