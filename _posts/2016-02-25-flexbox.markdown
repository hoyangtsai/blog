...
1. `flex: flex-grow flex-shrink flex-basis | auto | initial | inherit;`
 > The flex property specifies the length of the item, relative to the rest of the flexible items inside the same container.
  ...
  {% include post_image.html src="https://i.imgur.com/GGqXMDo.png" alt="flex" width="472" height="406" %}
...
2. flex-basis
  ...
  ```
  {% include post_image.html src="https://i.imgur.com/iEEvi98.png" alt="flex-basis" width="468" height="117" %}
