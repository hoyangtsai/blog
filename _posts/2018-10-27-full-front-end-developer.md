...
{% include post_image.html src="/images/full-f2e-devpr/matrial_design.png" alt="matrial_design" width="auto" height="100%" %}

{% include post_image.html src="/images/full-f2e-devpr/ant_design.png" alt="ant_design" width="auto" height="100%" %}
...
{% include post_image.html src="/images/full-f2e-devpr/ui_breakdown.jpeg" alt="UI breakdown" width="auto" height="100%" %}

1. 交互確認：了解設計師最終想要呈現的效果

{% include post_image.html src="/images/full-f2e-devpr/ux-ensure.gif" alt="UX Ensure" width="auto" height="100%" %}
...
{% include post_image.html src="/images/full-f2e-devpr/ps-and-sketch.jpeg" alt="PS and Sketch usage" width="auto" height="100%" %}
...
{% include post_image.html src="/images/full-f2e-devpr/base64_icon.png" alt="Base64 icon" width="auto" height="100%" %}
