...
{% include post_image.html src="/images/full-f2e-devpr/matrial_design.png" alt="matrial_design" width="100%" height="auto" %}

{% include post_image.html src="/images/full-f2e-devpr/ant_design.png" alt="ant_design" width="100%" height="auto" %}
...
{% include post_image.html src="/images/full-f2e-devpr/ui_breakdown.jpeg" alt="UI breakdown" width="100%" height="auto" %}

1. 交互確認：了解設計師最終想要呈現的效果

{% include post_image.html src="/images/full-f2e-devpr/ux-ensure.gif" alt="UX Ensure" width="100%" height="auto" %}
...
{% include post_image.html src="/images/full-f2e-devpr/ps-and-sketch.jpeg" alt="PS and Sketch usage" width="100%" height="auto" %}
...
{% include post_image.html src="/images/full-f2e-devpr/base64_icon.png" alt="Base64 icon" width="29" height="100%" %}
