...
layout: post
title: 最佳化圖片
tags: [optimize-image, image-compression, google, google-developers, pagespeed-insights]
published: true
permalink: /posts/2015/optimize-image/
---
...
### 批量執行
批量執行圖片最佳化，先變更路徑 `cd /path` 到專案目錄，使用下方組合技
{% highlight bash %}
