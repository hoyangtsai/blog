...
{% include post_image.html src="/assets/image/develop-super-easy-chatbot-release-online/create-provider.png" alt="create provider" width="100%" height="auto" %}

進入剛建的 provider 頁面

新建一個 channel 選擇 `Messaging API`

{% include post_image.html src="/assets/image/develop-super-easy-chatbot-release-online/create-channel.png" alt="create channel" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/develop-super-easy-chatbot-release-online/webhook-url.png" alt="webhook url" width="100%" height="auto" %}

點擊驗證確認連接成功

{% include post_image.html src="/assets/image/develop-super-easy-chatbot-release-online/webhook-verify.png" alt="webhook verify" width="100%" height="auto" %}

最後記得把 Use webhook 開啟

{% include post_image.html src="/assets/image/develop-super-easy-chatbot-release-online/use-webhook.png" alt="use webhook" width="100%" height="auto" %}

### 服務溝通

在應用設置的 Messaging API 最上面的 Bot basic ID 和 QR Code

{% include post_image.html src="/assets/image/develop-super-easy-chatbot-release-online/line-id.png" alt="Line ID" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/develop-super-easy-chatbot-release-online/line-message-edit.png" alt="Line message edit" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/develop-super-easy-chatbot-release-online/heroku-create.png" alt="Heroku create" width="100%" height="auto" %}

### 上傳準備

剛新建的 URL 就是替換 Line 的 Webhook URL 的線上連結

{% include post_image.html src="/assets/image/develop-super-easy-chatbot-release-online/webhook-heroku-url.png" alt="webhook Heroku URL" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/develop-super-easy-chatbot-release-online/heroku-config-vars.png" alt="Heroku config vars" width="100%" height="auto" %}
