...
{% include post_image.html src="/assets/image/css-class-naming-mothodology/class-naming.png" alt="CSS naming" width="60%" height="auto" %}
...
<figure>
  {% include post_image.html src="/assets/image/css-class-naming-mothodology/oocss-before-separation.png" alt="分解之前" width="60%" height="auto" %}
  <figcaption>▲ 這個是個比較極端的案例，我們可以發現這三個元素都有這幾個相同的樣式</figcaption>
</figure>
...
<figure>
  ...
  {% include post_image.html src="/assets/image/css-class-naming-mothodology/oocss-demo-1-code.png" alt="Demo 1" width="100%" height="auto" %}
  {% include post_image.html src="/assets/image/css-class-naming-mothodology/oocss-demo-1-img.png" alt="Demo 1" width="100%" height="auto" %}
</figure>

<figure>
  <figcaption>Demo 2</figcaption>
  {% include post_image.html src="/assets/image/css-class-naming-mothodology/oocss-demo-2-code.png" alt="Demo 2" width="100%" height="auto" %}
  {% include post_image.html src="/assets/image/css-class-naming-mothodology/oocss-demo-2-img.png" alt="Demo 2" width="100%" height="auto" %}
</figure>

<figure>
  <figcaption>Demo 3</figcaption>
  {% include post_image.html src="/assets/image/css-class-naming-mothodology/oocss-demo-3-code.png" alt="Demo 3" width="100%" height="auto" %}
  {% include post_image.html src="/assets/image/css-class-naming-mothodology/oocss-demo-3-img.png" alt="Demo 3" width="100%" height="auto" %}
</figure>

這個是 OOCSS 所提供的內容，裡面清楚的標示了有哪些屬性以及是否為必填項

{% include post_image.html src="/assets/image/css-class-naming-mothodology/oocss-properties.png" alt="OOCSS 屬性表" width="100%" height="auto" %}
...
<figure>
  <figcaption>可以把整個 TAB 切換看成是一個 Block</figcaption>
  {% include post_image.html src="/assets/image/css-class-naming-mothodology/bem-block.png" alt="BEM Block" width="100%" height="auto" %}
</figure>
...
<figure>
  <figcaption>TAB 組件中的每個選項就是一個 Element</figcaption>
  {% include post_image.html src="/assets/image/css-class-naming-mothodology/bem-element.png" alt="BEM Element" width="100%" height="auto" %}
</figure>
...
<figure>
  <figcaption>TAB 組件中的每個選項的 hover、選中狀態都是 Modifier</figcaption>
  {% include post_image.html src="/assets/image/css-class-naming-mothodology/bem-modifier.png" alt="BEM Modifier" width="100%" height="auto" %}
</figure>

最後，我們來看看依照 BEM 的架構來區分檔案結構會是長這樣子的

{% include post_image.html src="/assets/image/css-class-naming-mothodology/bem-file-structure.png" alt="BEM 檔案結構" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/css-class-naming-mothodology/smacss-base.png" alt="SMACSS Base" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/css-class-naming-mothodology/smacss-layout.png" alt="SMACSS Layout" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/css-class-naming-mothodology/smacss-module.png" alt="SMACSS Module" width="100%" height="auto" %}
...
{% include post_image.html src="/assets/image/css-class-naming-mothodology/smacss-state.png" alt="SMACSS State" width="100%" height="auto" %}

#### Theme Rules

針對網站主視覺做定義，像是品牌色或字型等等

{% include post_image.html src="/assets/image/css-class-naming-mothodology/smacss-theme.png" alt="SMACSS Theme" width="100%" height="auto" %}

### CSS 框架

最後來介紹一個由YAHOO開發的框架 - Atomic CSS
...
{% include post_image.html src="/assets/image/css-class-naming-mothodology/atomic-config.png" alt="Atomic 定義文件" width="100%" height="auto" %}
▲ 這個是定義檔案，支持定義參數

{% include post_image.html src="/assets/image/css-class-naming-mothodology/atomic-use.png" alt="Atomic 使用" width="100%" height="auto" %}
▲ HTML的使用方式
...
{% include post_image.html src="/assets/image/css-class-naming-mothodology/atomic-result.png" alt="Atomic 最終結果" width="100%" height="auto" %}
▲ 最終結果
