...
{:.text-center}
<a href="javascript:goBack()" class="social-icons" title="Return to previous page"><i class="fas fa-arrow-circle-left"></i></a>
...
<div class="searchcont2">
    <!-- span class="searchicon2"><i class="fas fa-search fa-2x"></i></span -->
