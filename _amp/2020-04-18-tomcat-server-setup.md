...
{% include post_image.html src="/images/tomcat-server-setup/tomcat_local.png" alt="tomcat_local" width="535" height="352" %}
...
{% include post_image.html src="/images/tomcat-server-setup/tomcat_server.png" alt="tomcat_server" width="800" height="669" %}

{% include post_image.html src="/images/tomcat-server-setup/tomcat_config_1.png" alt="tomcat_config_1" width="1070px" height="700px" %}

{% include post_image.html src="/images/tomcat-server-setup/tomcat_config_2.png" alt="tomcat_config_1" width="476" height="494" layout="fixed" %}
