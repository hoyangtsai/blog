...
<li>啟動資料庫 (操作指令和使用 MySQL 一樣)

{% highlight bash %}
mysql.server start
{% endhighlight %}
</li>
<li>設定 root 登入密碼和其他 configuration 完成安裝
...
[OSX How To: Uninstall native MySQL and install MariaDB via Homebrew](https://gist.github.com/brandonsimpson/5204ce8a46f7a20071b5)<br>
