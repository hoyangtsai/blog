...
published: true
comments: true
tags: [入門教學, gettingStarted, github, gh-pages, jekyll, bundler, ruby, commandLine, tutorial]
---
...
{% include post_image.html src="/images/ruby_guard_processes.png" alt="ruby guard processes" width="829" height="601" %}
